            ...
            <div class = "flex space-x-3 items-center px-3">
                <div class = "flex-none flex justify-center">
                    <div class="w-8 h-8 flex ">
                        <img src="{{ Auth::user()->avatar === null ? asset('storage/images/default_avatar.png') : asset('storage/'. Auth::user()->avatar) }}" alt="profile" class="shadow rounded-full object-cover" />
                    </div>
                </div>
