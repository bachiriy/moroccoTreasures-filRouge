...
@section('content')
    ...
    <div class="flex flex-col h-screen">
        ...
        <h1 class="text-xl text-center font-bold mt-10">Catalog of Your Ordered Products</h1>
        <p class="text-gray-500 text-xs text-center mt-4 pb-6 border-b border-gray-200">Essential Step: Prioritize Direct Communication with Buyers to Confirm Orders, Ensuring Prompt Shipping and Customer Satisfaction.</p>
