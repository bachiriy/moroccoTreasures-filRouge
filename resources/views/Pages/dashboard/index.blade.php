...
<div class="ml-auto lg:w-[75%] xl:w-[80%] 2xl:w-[85%] overflow-hidden bg-gradient-to-l from-gray-900 to-red-950 h-screen">
    ...
    <div class="my-12 mx-6 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-4">
        <div class="relative flex flex-col bg-clip-border rounded-xl border border-gray-200 text-blue-400 shadow-md">
        ...
        <div class="relative flex flex-col bg-clip-border rounded-xl  border border-gray-200 text-pink-500 shadow-md">
        ...
        <div class="relative flex flex-col bg-clip-border rounded-xl border border-gray-200 text-green-400 shadow-md">
        ...
        <div class="relative flex flex-col bg-clip-border rounded-xl border border-gray-200 text-orange-400 shadow-md">
