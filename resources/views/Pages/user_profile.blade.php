    ...
    <div class="bg-gradient-to-r from-gray-900 to-gray-950 w-full flex flex-col gap-5 px-3 md:px-16 lg:px-28 md:flex-row text-[#161931]">
        <aside class="hidden py-4 md:w-1/3 lg:w-1/4 md:block">
            <div class="sticky flex flex-col gap-2 p-4 text-sm border-r border-indigo-100 text-white top-12">
                ...
                <button onclick="showDiv1(this)"
                   class="sittings_btn flex items-center px-3 py-2.5 font-semibold text-white hover:opacity-70 border-red-700 border rounded-full">
                    Account Settings
                </button>
                <button onclick="showDiv2(this)"
                   class="sittings_btn flex items-center px-3 py-2.5 font-semibold text-white hover:opacity-70 ">
                    Change Password
                </button>
            </div>
        </aside>
                        ...
                        <div class="items-center mt-8 sm:mt-14 text-[#202142]">
                            ...
                            <div
                                ...
                                <div class="w-full">
                                    ...
                                    <input type="text" name="name"
                                           id="name"
                                           class="bg-gradient-to-l from-gray-900 to-red-950 border border-indigo-300 text-gray-200 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5 "
                            ...
                            <div class="mb-2 sm:mb-6">
                                ...
                                <input type="email" id="email" name="email"
                                       class="bg-gradient-to-l from-gray-900 to-red-950 border border-indigo-300 text-gray-100 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5 "
                            ...
                            <div class="mb-2 sm:mb-6">
                                <label for="profession"
                                       class="block mb-2 text-sm font-medium text-gray-500 ">Role</label>
                            ...
                            <div class="flex justify-end">
                                <button type="submit"
                                        class="text-white bg-red-950 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-red-700 dark:hover:bg-red-800 dark:focus:ring-red-800">
                                    Save
                                </button>
                            </div>
